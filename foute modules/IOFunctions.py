...
verdeelPunten2B = [250,675,1100,1600,1950,2450,2900,3400]
...
def IORecognition(communicationSequences, minSeqLength, allLengths, semaphore):
    data = read(dataStringRec)
    print(dataStringRec)
    for einde in range(minSeqLength,len(data)+1,2):
        for seqLengte in allLengths:
