...
class TimeSequence(object):
    ...
    def getDistribution(self):
        return self.getSaxWord().getDistribution()
    ...
    def makeSaxWord(self, alphabetSize, valuesPerLetter, distribution=None, letterWaarden= None):
        """
        ...
        """
        self.saxWord = SaxWord.SaxWord(self.vector, alphabetSize, valuesPerLetter, distribution, letterWaarden)
